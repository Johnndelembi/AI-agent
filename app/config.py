...
class Settings:
    ...
    BROWSERLESS_API_TOKEN: str = os.getenv("BROWSERLESS_API_TOKEN", "")
    BROWSERLESS_ENDPOINT: str = os.getenv(
        "BROWSERLESS_ENDPOINT",
        "wss://production-sfo.browserless.io/chromium/stealth",
    )
    BROWSERLESS_PROXY: str = os.getenv("BROWSERLESS_PROXY", "")
    BROWSERLESS_SOLVE_CAPTCHAS: bool = os.getenv("BROWSERLESS_SOLVE_CAPTCHAS", "false").lower() == "true"
...
BROWSERLESS_API_TOKEN = settings.BROWSERLESS_API_TOKEN
BROWSERLESS_ENDPOINT = settings.BROWSERLESS_ENDPOINT
BROWSERLESS_PROXY = settings.BROWSERLESS_PROXY
BROWSERLESS_SOLVE_CAPTCHAS = settings.BROWSERLESS_SOLVE_CAPTCHAS

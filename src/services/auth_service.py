...
SUPERBASE_SECRET_KEY = os.getenv("SUPERB_SECRET_KEY", "your-superb-secret-key-change-this-in-production")
ALGORITHM = "HS256"
...
class AuthService:
    ...
    def create_access_token(data: dict, expires_delta: Optional[timedelta] = None) -> str:
        ...
        encoded_jwt = jwt.encode(to_encode, SUPERBASE_SECRET_KEY, algorithm=ALGORITHM)
        return encoded_jwt
    ...
    def verify_token(token: str) -> Dict[str, Any]:
        ...
        try:
            payload = jwt.decode(token, SUPERBASE_SECRET_KEY, algorithms=[ALGORITHM])
            return payload
